...
class image_converter:
  ...
  def __init__(self):
    ...
    self.circle1_pub2 = rospy.Publisher("circle1_xz", Float64MultiArray, queue_size=10)
  ...
  def callback2(self,data):
    ...
    self.circle1_2.data=circle1
    
    self.circle2_2=Float64MultiArray()
    self.circle2_2.data=circle2
    
    self.circle3_2=Float64MultiArray()
    self.circle3_2.data=circle3
    ...
    try: 
      ...
      self.circle1_pub2.publish(self.circle1_2)      
